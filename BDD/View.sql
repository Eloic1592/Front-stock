...
SELECT pi.idplainte,concat(u.nom,' ',prenom) as nom,tu.type_utilisateur,m.materiel,pi.description,p.date_depot FROM plainte_individuel pi 
...
SELECT pi.idplainte,concat(u.salle) as salle,m.materiel,pi.description,p.date_depot FROM plainte_salle pi 
